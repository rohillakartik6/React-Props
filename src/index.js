...
function Card(props) {
  ...
  return (
    <div className={props.className}>
      ...
      <p>{props.tel}</p>
      <p>{props.email}</p>
      <input id="fname" placeholder="Enter Your Name" value="kartik-rohilla" />
    </div>
  );
}
